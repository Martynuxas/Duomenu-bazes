...
public class HashMap<K, V> implements EvaluableMap<K, V> {
     ...
     * @return true if map has key for this value
     */
    ...
    /**
     * @return null if value added successfully, found value if key already exists
     */
    ...
    /**
     * @return number of empty elements in internal array
     */

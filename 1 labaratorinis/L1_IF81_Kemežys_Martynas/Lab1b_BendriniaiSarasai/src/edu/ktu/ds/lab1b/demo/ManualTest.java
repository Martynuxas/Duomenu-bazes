...
//        checkCarMarketSorting();
    ...
    void createCarList() {
        ...
        Car c2 = new Car("Renault", "Megane", 2001, 20000, 3500);
        Car c3 = new Car("Toyota", "Corolla", 2001, 20000, 8500.8);
        Car c4 = new Car("Audi A4 2003 115900 7500");
        Car c8 = new Car("Audi A8 2013 115900 7500");
        cars.add(c1);
        cars.addLast(c4);
        cars.add(c2);
        cars.add(c3);
        ...
        //cars.add(0, new Car("Hyundai","Lantra",1998,9500,777));
//        cars.set(4, c3);
...
//        cars.remove(0);
        cars.add(c4);
        cars.removeLastOccurrence(c4);
        cars.addLast(c8);
        cars.println("Po visų išmetimų");
        cars.subList(2,4);

        String str = new String("Wbelcome to geeksforgeeks");
	char ch = 'b';
	char ch2 = 's';
        long t1 = System.nanoTime();
	int posOfB = str.indexOf(ch);
        long t2 = System.nanoTime();
        posOfB = str.indexOf(ch);
        ...
        Ks.ouf("%7.4f %7.4f %7.4f %7.4f %7.4f\n",(t2-t1)/1e9, (t3-t2)/1e9, (t4-t3)/1e9,(t5-t4)/1e9,(t6-t5)/1e9);
        Ks.ouf("%7.4f %7.4f %7.4f %7.4f %7.4f\n",(t7-t6)/1e9, (t8-t7)/1e9, (t9-t8)/1e9,(t10-t9)/1e9,(t11-t10)/1e9);

        long t1 = System.nanoTime();
        for (int i = 1; i < 10; i++) {
            Ks.oun(i+" "+ Math.pow(i, 1.0/3));;
        }
        long t2 = System.nanoTime();
        for (int i = 10; i < 20; i++) {
            Ks.oun(i+" "+ Math.pow(i, 1.0/3));
        ...
        Ks.ouf("%7.4f %7.4f %7.4f %7.4f %7.4f\n",(t8-t7)/1e9, (t9-t8)/1e9, (t10-t9)/1e9,(t11-t10)/1e9,(t12-t11)/1e9);
    }

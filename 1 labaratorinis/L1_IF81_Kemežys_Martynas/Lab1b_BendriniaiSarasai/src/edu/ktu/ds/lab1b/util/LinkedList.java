...
public class LinkedList<E extends Comparable<E>>
    ...
    //Metodas kuris objekta prideda gale sąrašo
    ...
    //Metodas kuris pašalina paskutinį rasta objekta
    ...
    //Metodas kuris pateikia objektus nuo tam tikros vietos iki tam tikros pabaigos
    public List<E> subList(int fromIndex, int toIndex)
    {
        ...
        Ks.oun("=======subList veikimas========");
        for (int i = fromIndex; i <= toIndex; i++) {
            test = first.findNode(i);
           list.add(test.element);
           Ks.oun(i + " " +test.element);
        }
        return list;
    }
    /**
